            ...
            <div className="storeRegisterContainer">
                ...
                <div className="mainContent">
                        ...
                        <table className="registerTable">
                            <tbody>
                                <tr>
                                    <td>매장이름</td>
                                    <td>
                                        <input type="text" name="storeName" onChange={edit} className={
                                            isStoreNameValid === false ? "inputFalse"
                                                : isStoreNameValid === true ? "inputSuccess"
                                                    : ""}
                                        />
                                        <button type="button" className="checkButton" onClick={checkStoreName}>중복확인</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>매장위치</td>
                                ...
                                <tr>
                                    <td>매장 계정</td>
                                    <td>
                                        <input type="text" name="storeAccount" placeholder="아이디" onChange={edit} className={isUsernameValid === false ? "inputFalse" : isUsernameValid === true ? "inputSuccess" : ""} />
                                        <button type="button" className="checkButton" onClick={checkUsername}>중복확인</button>
                    ...
                    <div className="submitSection">
                        <button className="submitButton" onClick={registerStore}>저장</button>
                    </div>
                </div>
            </div>
            {isOpen &&
